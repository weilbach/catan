...
class ConvNet2(object):
    ...
    def __init__(self, input_dim=(1, 28, 28), num_classes=10):
        ...
        self.params['W4'] = np.random.normal(scale=weight_scale, size=((2473500, 11)))

        # self.params['b1'] = np.zeros(6)
        # self.params['b2'] = np.zeros(16)
        # self.params['b3'] = np.zeros(128)
        self.params['b4'] = np.zeros(11)
    ...
    #     scores, forward_cache2 = fc_forward(relu3, W4, b4)
        scores, forward_cache = fc_forward(X, W4, b4)
        # print(scores)
        ...
        dx_4, grads['W4'], grads['b4'] = fc_backward(dscores, forward_cache)
        #affine backwards
